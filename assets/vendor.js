...
! function(t, e) {
    ...
    const x = (t, e, n) => (((1 - 3 * n + 3 * e) * t + (3 * n - 6 * e)) * t + 3 * e) * t;
    ...
    function O(t, e, n, i) {
        ...
        const r = e => function(t, e, n, i, r) {
            let o, s, a = 0;
            do {
                s = e + (n - e) / 2, o = x(s, i, r) - t, o > 0 ? n = s : e = s
    ...
    class A {
        constructor(t, e = [0, 1], {
            ...
            if (this.startTime = null, this.rate = 1, this.t = 0, this.cancelTimestamp = null, this.easing = u, this.duration = 0, this.totalDuration = 0, this.repeat = 0, this.playState = "idle", this.finished = new Promise(((t, e) => {
                    this.resolve = t, this.reject = e
                })), n = n || r.easing, m(n)) {
                const t = n.createAnimation(e);
                n = t.easing, e = t.keyframes || e, i = t.duration || i
            }
            this.repeat = c, this.easing = s(n) ? u : T(n), this.updateDuration(i);
            ...
            this.tick = e => {
                ...
                !c && r >= 1 && (c = 1), 1 === c && s--;
                const l = s % 2;
                ("reverse" === f || "alternate" === f && l || "alternate-reverse" === f && !l) && (c = 1 - c);
                const u = i >= this.totalDuration ? 1 : Math.min(c, 1),
                    d = h(this.easing(u));
                t(d);
                void 0 === this.pauseTime && ("finished" === this.playState || i >= this.totalDuration + a) ? (this.playState = "finished", null === (n = this.resolve) || void 0 === n || n.call(this, d)) : "idle" !== this.playState && (this.frameRequestId = requestAnimationFrame(this.tick))
            }, this.play()
        }
        play() {
    ...
    const K = (t, e) => y(t) ? Z.linearEasing() ? `linear(${((t,e)=>{let n="";const i=Math.round(e/.015);for(let e=0;e<i;e++)n+=t(f(0,i-1,e))+", ";return n.substring(0,n.length-2)})(t,e)})` : r.easing : p(t) ? X(t) : t,
    ...
    function nt(t, n, i, a = {}, c) {
        ...
        const L = J(n),
            ...
            R = B.get(L);
        return tt(W.animation, !(m(b) && W.generator) && !1 !== a.record), () => {
            const e = () => {
                var e, n;
                return null !== (n = null !== (e = Q.get(t, L)) && void 0 !== e ? e : null == R ? void 0 : R.initialValue) && void 0 !== n ? n : 0
            };
            let r = function(t, e) {
            ...
            if (I(L) && (Z.cssRegisterProperty() ? function(t) {
                    if (!U.has(t)) {
                        U.add(t);
                        try {
                            const {
                ...
                }(L) : A = !1), T && !Z.linearEasing() && (y(b) || s(b) && b.some(y)) && (A = !1), A) {
                R && (r = r.map((t => o(t) ? R.toDefaultUnit(t) : t))), 1 !== r.length || Z.partialKeyframes() && !f || r.unshift(e());
                const n = {
                    delay: w(g),
                    duration: w(d),
                    endDelay: w(p),
                ...
                }, n), h.finished || (h.finished = new Promise(((t, e) => {
                    h.onfinish = t, h.oncancel = e
                })));
                const i = r[r.length - 1];
                h.finished.then((() => {
                    E || (Q.set(t, L, i), h.cancel())
                })).catch(l), S || (h.playbackRate = 1.000001)
            } else if (c && T) r = r.map((t => "string" == typeof t ? parseFloat(t) : t)), 1 === r.length && r.unshift(parseFloat(e())), h = new c((e => {
                Q.set(t, L, M ? M(e) : e)
            ...
            return f && u(t, n, r, {
                ...
                repeat: v,
                offset: O
            }, "motion-one"), W.setAnimation(h), h
        }
    }
    const it = (t, e) => t[e] ? Object.assign(Object.assign({}, t), t[e]) : Object.assign({}, t);
        ...
        at = {
            get: (t, e) => {
                ...
                switch (e) {
                    ...
                    case "finished":
                        return t.finished || (t.finished = Promise.all(t.animations.map(ct)).catch(l)), t.finished;
                    case "stop":
                        return () => {
    ...
    function dt(t, e, n, i) {
        var r;
        return o(e) ? e : e.startsWith("-") || e.startsWith("+") ? Math.max(0, t + parseFloat(e)) : "<" === e ? n : null !== (r = i.get(e)) && void 0 !== r ? r : t
    }
    ...
    const xt = ({
        ...
        if (f < 1) {
            ...
            h = e => r - Math.exp(-f * u * e) * ((f * u * l - o) / t * Math.sin(t * e) + l * Math.cos(t * e))
        ...
        return t => {
            ...
            var u, f, d;
            return c.done = n && l, c.hasReachedTarget = (u = i, f = r, d = c.current, u < f && d >= f || u > f && d <= f), c
        }
    };
    ...
    function Mt(t) {
        ...
        return (n = {}) => {
            const i = new Map,
                r = (e = 0, r = 100, o = 0, s = !1) => {
                    const a = `${e}-${r}-${o}-${s}`;
                    return i.has(a) || i.set(a, t(Object.assign({
                        from: e,
                        to: r,
                        velocity: o,
                        restSpeed: s ? .05 : 2,
                ...
                o = (t, n) => (e.has(t) || e.set(t, function(t, e = u) {
                    let n, i = 10,
                        r = t(0);
                    const o = [e(r.current)];
                    for (; !r.done && i < 1e4;) r = t(i), o.push(e(r.done ? r.target : r.current)), void 0 === n && r.hasReachedTarget && (n = i), i += 10;
                    const s = i - 10;
                    return 1 === o.length && o.push(r.current), {
                        keyframes: o,
                        duration: s / 1e3,
                ...
                createAnimation: (t, e = !0, n, i, s) => {
                    ...
                    if (e) {
                        ...
                        if (l = St(t[d - 1]), d > 1 && null !== t[0]) c = St(t[0]);
                            ...
                            if (t) {
                                ...
                                } = s, i = (null == e ? void 0 : e.startTime) || n || 0, r = (null == e ? void 0 : e.currentTime) || performance.now() - i, o = t(r).current;
                    ...
                    if (Ot(c) && Ot(l)) {
                        ...
                        a = Object.assign(Object.assign({}, o(t, h)), {
                            easing: "linear"
                        }), s && (s.generator = t, s.generatorStartTime = performance.now())
                    }
                    if (!a) {
                        a = {
                            easing: "ease",
    ...
    const Tt = Mt(xt),
        At = Mt((({
            ...
            const f = {
                ...
                h = t => void 0 === a ? c : void 0 === c || Math.abs(a - t) < Math.abs(c - t) ? a : c;
            let d = n * e;
            const g = t + d,
                p = void 0 === s ? g : s(g);
            ...
            const x = t => {
                var e;
                (e = f.current, void 0 !== a && e < a || void 0 !== c && e > c) && (b = t, E = xt({
                    from: f.current,
                    to: h(f.current),
            ...
            return x(0), t => {
                let e = !1;
                return E || void 0 !== b || (e = !0, v(t), x(t)), void 0 !== b && t > b ? (f.hasReachedTarget = !0, E(t - b)) : (f.hasReachedTarget = !1, !e && v(t), f)
            }
        })),
        Dt = {
            any: 0,
    ...
    function jt({
        ...
        var i;
        null === (i = kt.get(t)) || void 0 === i || i.forEach((i => {
            i({
                target: t,
                contentSize: e,
                get size() {
    ...
    function zt(t, e) {
        Wt || "undefined" != typeof ResizeObserver && (Wt = new ResizeObserver(Rt));
        const n = rt(t);
        return n.forEach((t => {
            let n = kt.get(t);
            n || (n = new Set, kt.set(t, n)), n.add(e), null == Wt || Wt.observe(t)
        })), () => {
            n.forEach((t => {
                const n = kt.get(t);
                null == n || n.delete(e), (null == n ? void 0 : n.size) || null == Wt || Wt.unobserve(t)
            }))
        }
    }
    const Bt = new Set;
    ...
    function Ct(t, e, n, i) {
        const r = n[e],
            ...
            a = r.current,
            c = n.time;
        r.current = t["scroll" + s], r.scrollLength = t["scroll" + o] - t["client" + o], r.offset.length = 0, r.offset[0] = 0, r.offset[1] = r.scrollLength, r.progress = f(0, r.scrollLength, r.current);
        const l = i - c;
    ...
    function Nt(t, e, n, i) {
        let r = Array.isArray(t) ? t : Ut,
            s = 0,
            a = 0;
        return o(t) ? r = [t, t] : v(t) && (r = (t = t.trim()).includes(" ") ? t.split(" ") : [t, Ht[t] ? t : "0"]), s = It(r[0], n, i), a = It(r[1], e), s - a
    }
    const _t = {
        x: 0,
        y: 0
    ...
    function Gt(t, e, n) {
        ...
        const {
            ...
            for (; i && i !== e;)
                ...
                for (n.x += e, n.y += t; i && "svg" !== i.tagName;) i = i.parentNode
            }
            return n
        }(r, t) : _t, c = r === t ? {
            width: t.scrollWidth,
        ...
        u && (e[o].interpolate = g(d(f), e[o].offset), e[o].interpolatorOffsets = [...e[o].offset]), e[o].progress = e[o].interpolate(e[o].current)
    }
    ...
    function Zt(t, e, n, i = {}) {
        ...
        return {
            ...
            update: e => {
                ...
                }(t, n, e), (i.offset || i.target) && Gt(t, n, i)
            },
    ...
    function Kt(t, e) {
        return t.pause(), t.forEachNative(((t, {
            ...
            if (t.updateDuration) e || (t.easing = u), t.updateDuration(1);
                ...
                e || (r.easing = "linear"), null === (i = null === (n = t.effect) || void 0 === n ? void 0 : n.updateTiming) || void 0 === i || i.call(n, r)
            }
        })), () => {
        ...
        fe = {
            inView: {
                ...
                subscribe: (t, {
                    ...
                    return Lt(t, (i => {
                        if (e(), le(t, "viewenter", i), !r) return e => {
                            n(), le(t, "viewleave", e)
                        }
                    }), o)
                }
            ...
            press: {
                ...
                subscribe: (t, {
                    ...
                    const i = e => {
                            n(), ce(t, "pressend", e), window.removeEventListener("pointerup", i)
                        },
                        r = n => {
                            e(), ce(t, "pressstart", n), window.addEventListener("pointerup", i)
                        };
    ...
    t.MotionValue = D, t.ScrollOffset = Ft, t.animate = function(t, e, n) {
        return (y(t) ? me : ft)(t, e, n)
    }, t.animateStyle = nt, t.createAnimate = ut, t.createMotionState = function(t = {}, e) {
        ...
        const o = {
            ...
            s = {},
            a = {};
        for (const n of he) a[n] = "string" == typeof t[n] ? t[n] : null == e ? void 0 : e.getContext()[n];
            ...
            g = {
                ...
                animateUpdates: function*() {
                    ...
                    for (const i of he) {
                        ...
                        const r = te(t[i]);
                        if (r)
                            for (const i in r) "transition" !== i && (u[i] = r[i], s[i] = it(null !== (n = null !== (e = r.transition) && void 0 !== e ? e : t.transition) && void 0 !== n ? n : {}, i))
                    }
                    const a = new Set([...Object.keys(u), ...Object.keys(r)]),
                        c = [];
                    a.forEach((t => {
                        var e, n, o;
                        void 0 === u[t] && (u[t] = f[t]), n = r[t], o = u[t], typeof n == typeof o && (Array.isArray(n) && Array.isArray(o) ? function(t, e) {
                            const n = e.length;
                            if (n !== t.length) return !1;
                            for (let i = 0; i < n; i++)
                                if (e[i] !== t[i]) return !1;
                            return !0
                        }(n, o) : n === o) || (null !== (e = f[t]) && void 0 !== e || (f[t] = Q.get(i, t)), c.push(nt(i, t, u[t], s[t], A)))
                    })), yield;
                    const h = c.map((t => t())).filter(Boolean);
                    if (!h.length) return;
                    const d = u;
                    i.dispatchEvent(ae("motionstart", d)), Promise.all(h.map((t => t.finished))).then((() => {
        ...
        const e = ge(t);
        let n = "";
        for (const t in e) n += t.startsWith("--") ? t : t.replace(/[A-Z]/g, pe), n += `: ${e[t]}; `;
        return n
    }, t.createStyles = ge, t.getAnimationData = k, t.getStyleName = J, t.glide = At, t.inView = Lt, t.mountedStates = de, t.resize = $t, t.scroll = function(t, e = {}) {
        var {
        ...
        if (r.add(o), !Xt.has(n)) {
            ...
            window.addEventListener("resize", t, {
                passive: !0
            }), n !== document.documentElement && Yt.set(n, $t(n, t)), e.addEventListener("scroll", t, {
                passive: !0
            })
        }
        const s = Xt.get(n),
        ...
        return () => {
            ...
            const r = Xt.get(n);
            Xt.delete(n), r && (Qt(n).removeEventListener("scroll", r), null === (e = Yt.get(n)) || void 0 === e || e(), window.removeEventListener("resize", r))
        }
    }, t.spring = Tt, t.stagger = function(t = .1, {
        start: e = 0,
        from: n = 0,
        easing: i
    } = {}) {
        return (r, s) => {
            const a = o(n) ? n : function(t, e) {
                    if ("first" === t) return 0;
                    {
                        const n = e - 1;
                        return "last" === t ? n : n / 2
    ...
    }, t.style = Q, t.timeline = function(t, e = {}) {
        var n;
        const i = function(t, e = {}) {
                var {
                    defaultOptions: n = {}
                } = e, i = ht(e, ["defaultOptions"]);
                const o = [],
                    s = new Map,
                    a = {},
                    c = new Map;
                ...
                for (let e = 0; e < t.length; e++) {
                    ...
                    for (let t = 0; t < b; t++) {
                        ...
                        for (const i in f) {
                            ...
                            O > 0 && h(x, O), 1 === s.length && s.unshift(null), gt(o, s, l, x, w, E), y = Math.max(v + c, y), g = Math.max(E, g)
                        }
                    }
                    l = u, u += y
                }
                return s.forEach(((t, e) => {
                    for (const s in t) {
                        ...
                        0 !== l[0] && (l.unshift(0), c.unshift(c[0]), u.unshift("linear")), 1 !== l[l.length - 1] && (l.push(1), c.push(null)), o.push([e, s, c, Object.assign(Object.assign(Object.assign({}, n), {
                            duration: g,
                            easing: u,
                            offset: l
                        }), i)])
        ...
        return st(o, e, null === (n = i[0]) || void 0 === n ? void 0 : n[3].duration)
    }, t.withControls = st, Object.defineProperty(t, "__esModule", {
        value: !0
    })
}));
! function(t, e) {
...
function(t, e) {
    ...
    return e.length,
        function(i) {
            ...
            let p = t(s.height);
            return !1 !== p && (n.height = p + (o ? 0 : h + d)), n.innerWidth = n.width - (l + c), n.innerHeight = n.height - (h + d), n.outerWidth = n.width + r, n.outerHeight = n.height + a, n
        }
})),
function(t, e) {
    ...
    let e = {
        ...
        i = t.console;
    return e.htmlInit = function(t, s) {
        e.docReady((function() {
            let n = "data-" + e.toDashed(s);
            [...document.querySelectorAll(`[${n}]`)].forEach((e => {
                let s, o = e.getAttribute(n);
                try {
                    s = o && JSON.parse(o)
                } catch (s) {
                    return void(i && i.error(`Error parsing ${n}on ${e.className}:${s}`))
                }
                new t(e, s)
            }))
        }))
...
function(t, e) {
    ...
    function i() {}
    let s, n, o = i.prototype = Object.create(e.prototype);
...
function(t, e) {
    if ("object" == typeof module && module.exports) module.exports = e(t, require("ev-emitter"), require("get-size"), require("fizzy-ui-utils"), require("./cell"), require("./slide"), require("./animate"));
    else {
        let i = t.Flickity;
    ...
    let u = d.prototype;
    Object.assign(u, e.prototype), u._create = function() {
        let {
            resize: e,
            watchCSS: i,
            rightToLeft: s
        } = this.options, n = this.guid = ++a;
        this.element.flickityGUID = n, c[n] = this, this.selectedIndex = 0, this.restingFrames = 0, this.x = 0, this.velocity = 0, this.beginMargin = s ? "marginRight" : "marginLeft", this.endMargin = s ? "marginLeft" : "marginRight", this.viewport = document.createElement("div"), this.viewport.className = "flickity-viewport", this._createSlider(), this.focusableElems = [this.element], (e || i) && t.addEventListener("resize", this);
        ...
        this.cells.forEach(((n, l) => {
            ...
            let h = i.outerWidth - i.firstMargin + (n.size.outerWidth - n.size[e]);
            s(l, h) || (i.updateTarget(), i = new o(t, e, this.cellAlign), this.slides.push(i)), i.addCell(n)
    ...
    u.setCellAlign = function() {
        ...
        this.options.adaptiveHeightProperty ? this.element.style.setProperty("--max-height", `${t}px`) : this.viewport.style.height = `${t}px`
    ...
    const f = ["dragStart", "dragMove", "dragEnd", "pointerDown", "pointerMove", "pointerEnd", "staticClick"];
    let g = u.emitEvent;
    return u.emitEvent = function(t, e) {
        if ("staticClick" === t) {
    ...
    }, s.debounceMethod(d, "onresize", 150), u.resize = function() {
        ...
        this.options.watchCSS && (h(this.element, ":after").content.includes("flickity") ? this.activate() : this.deactivate())
    }, u.onkeydown = function(t) {
        let {
            activeElement: e
        } = document, i = d.keyboardHandlers[t.key];
    ...
    }, Object.assign(u, l), d.data = function(t) {
        if (t = s.getQueryElement(t)) return c[t.flickityGUID]
    }, s.htmlInit(d, "flickity"), d.Cell = n, d.Slide = o, d
})),
function(t, e) {
...
function(t, e) {
    ...
    i.prototype._create = function(t) {
        ...
        let {
            rightToLeft: t,
            arrowShape: e
        } = this.options, s = t ? "right" : "left", n = t ? "left" : "right";
    ...
    return s.updatePrevNextButtons = function() {
        ...
        this.prevButton.element.addEventListener("click", this.handlePrevButtonClick), this.nextButton.element.addEventListener("click", this.handleNextButtonClick), this.element.prepend(this.prevButton.element, this.nextButton.element), this.on("deactivate", this.deactivatePrevNextButtons)
...
function(t, e) {
    ...
    i.prototype.setDots = function(t) {
        ...
        let e = new Array(t).fill().map(((t, e) => {
            ...
            return i.className = "flickity-page-dot", i.setAttribute("aria-label", `View slide ${s}`), i
        }));
...
function(t, e) {
    "object" == typeof module && module.exports ? module.exports = e(require("flickity"), require("fizzy-ui-utils")) : e(t.Flickity, t.fizzyUIUtils)
}("undefined" != typeof window ? window : this, (function(t, e) {
    ...
    i.positionSliderAtSelected = function() {
        ...
        n /= s;
        let o = t.a;
        this.isDragging && (o = n > .5 ? t.a : t.b), void 0 !== this.fadeHideIndex && this.fadeHideIndex !== o && this.fadeHideIndex !== t.a && (this.fadeHideIndex, t.b), this.fadeHideIndex = o
...
! function(a, b) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = b() : "function" == typeof define && define.amd ? define(b) : a.Splitting = b()
}(this, function() {
    "use strict";
    ...
    function f(a, b, c, d) {
        ...
        return b && (e.className = b), c && (d || e.setAttribute("data-" + b, c), e.textContent = c), a && l(a, e) || e
    }
    ...
    function p(a, b) {
        return a && 0 != a.length ? a.nodeName ? [a] : [].slice.call(a[0].nodeName ? a : (b || x).querySelectorAll(a)) : []
    }
    ...
    function z(a, b, d, e, g) {
        ...
        return p(a.childNodes).some(function(a) {
            var j;
            a.tagName && !a.hasChildNodes() ? c.push(a) : a.childNodes && a.childNodes.length ? (c.push(a), h.push.apply(h, z(a, b, d, e, g))) : (j = (a = a.wholeText || "").trim()).length && (" " === a[0] && c.push(C(" ")), y("" === d && "function" == typeof Intl.Segmenter ? Array.from(new Intl.Segmenter().segment(j)).map(function(a) {
                return a.segment
            }) : j.split(d), function(a, d) {
                d && g && c.push(f(i, "whitespace", " ", g)), d = f(i, b, a), h.push(d), c.push(d)
            }), " " === a[a.length - 1]) && c.push(C(" "))
        }), y(c, function(a) {
            l(i, a)
        }), a.innerHTML = "", l(a, i), h
    }
    ...
    function g(b) {
        ...
        return p(b.target || "[data-splitting]").map(function(a) {
            var e, g, h = a["\uD83C\uDF4C"];
            return !b.force && h || (h = a["\uD83C\uDF4C"] = {
                el: a
            }, e = o(e = (e = b.by || d(a, "splitting")) && "true" != e ? e : "chars"), g = function(a, b) {
                for (var c in b) a[c] = b[c];
                return a
            }({}, b), y(e, function(b) {
                var c, d, i, j, k;
                b.split && (c = b.by, i = (f ? "-" + f : "") + b.key, b = b.split(a, g, h), i && (d = a, k = (i = "--" + (i = i)) + "-index", y(j = b, function(a, b) {
                    Array.isArray(a) ? y(a, function(a) {
                        q(a, k, b)
                    }) : q(a, k, b)
                }), q(d, i + "-total", j.length)), h[c] = b, a.classList.add(c))
            }), a.classList.add("splitting")), h
        })
    }
    ...
    var s = i("lines", [c], "line", function(a, d, f) {
        ...
        k = i("layout", D, D, function(a, b) {
            for (var g, h, j = b.rows = +(b.rows || d(a, "rows") || 1), k = b.columns = +(b.columns || d(a, "columns") || 1), m = (b.image = b.image || d(a, "image") || a.currentSrc || a.src, b.image && (g = p("img", a)[0], b.image = g && (g.currentSrc || g.src)), b.image && q(a, "background-image", "url(" + b.image + ")"), j * k), n = [], i = f(D, "cell-grid"); m--;) h = f(i, "cell"), f(h, "cell-inner"), n.push(h);
            return l(a, i), n
        }),
        A = i("cellRows", ["layout"], "row", function(a, b, c) {
            var d = b.rows,
                f = m(d);
            return y(c.layout, function(a, b, c) {
        ...
        E = i("cellColumns", ["layout"], "col", function(a, b, c) {
            var d = b.columns,
                e = m(d);
            return y(c.layout, function(a, b) {
                e[b % d].push(a)
            }), e
        }),
...
! function() {
    ...
    function aa(b, d) {
        var f = "undefined" != typeof Symbol && b[Symbol.iterator] || b["@@iterator"];
        if (!f) {
            if (Array.isArray(b) || (f = function(a, b) {
                    if (a) {
                        if ("string" == typeof a) return G(a, b);
                        var c = Object.prototype.toString.call(a).slice(8, -1);
                        return "Object" === c && a.constructor && (c = a.constructor.name), "Map" === c || "Set" === c ? Array.from(a) : "Arguments" === c || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(c) ? G(a, b) : void 0
                    }
                }(b)) || d && b && "number" == typeof b.length) {
                f && (b = f);
                var g = 0,
                    h = function() {};
                return {
    ...
    var n = function(b, c) {
            ...
            return function(g, e) {
                ...
                return h && b(e).then(function() {
                    new c(d).observe(g, {
                        attributes: !0,
                        attributeOldValue: !0,
                        attributeFilter: h
                    });
                    for (var b = 0, i = h.length; b < i; b++) g.hasAttribute(h[b]) && f({
                        target: g,
                        attributeName: h[b],
                        oldValue: null
                    })
        ...
        i = function(b) {
            var j = new f,
                k = function(d, e) {
                    var f;
                    if (e)
                        for (var g, h = function(a) {
                                return a.matches || a.webkitMatchesSelector || a.msMatchesSelector
                            }(d), k = 0, l = p.length; k < l; k++) h.call(d, g = p[k]) && (j.has(d) || j.set(d, new s), (f = j.get(d)).has(g) || (f.add(g), b.handle(d, e, g)));
                    else j.has(d) && (f = j.get(d), j.delete(d), f.forEach(function(a) {
                        b.handle(d, e, a)
                    }))
                },
                i = function(a) {
                    for (var b = !(1 < arguments.length && void 0 !== arguments[1]) || arguments[1], c = 0, d = a.length; c < d; c++) k(a[c], b)
                },
                p = b.query,
                l = b.root || r,
                g = function(a) {
                    var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : document,
                        d = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : MutationObserver,
                        g = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : ["*"],
                        i = function b(e, g, j, i, c, k) {
                            var l, m = aa(e);
                            try {
                                for (m.s(); !(l = m.n()).done;) {
                                    var d = l.value;
                                    (k || o in d) && (c ? j.has(d) || (j.add(d), i.delete(d), a(d, c)) : i.has(d) || (i.add(d), j.delete(d), a(d, c)), k || b(d[o](g), g, j, i, c, ba))
                                }
                            } catch (a) {
                                m.e(a)
                            } finally {
            ...
            return m && (c.prototype.attachShadow = function(a) {
                var b = m.call(this, a);
                ...
                flush: function() {
                    for (var a = g.takeRecords(), b = 0, c = a.length; b < c; b++) i(h.call(a[b].removedNodes, d), !1), i(h.call(a[b].addedNodes, d), !0)
                },
                observer: g,
                parse: i
            }
    ...
    if (P) {
        ...
        self.customElements = {
            define: function(a, b) {
                if (j.has(a)) throw new M("the name \"".concat(a, "\" has already been used with this registry"));
                H.set(b, a), $.set(a, b.prototype), j.set(a, b), R.push(a), _(a).then(function() {
            ...
            whenDefined: _
        }, O(L.prototype = A.prototype, "constructor", {
            value: L
        }), self.HTMLElement = L, v.createElement = function(a, b) {
            var c = b && b.is,
                d = c ? j.get(c) : j.get(a);
            return d ? new d : x.call(v, a)
        }, "isConnected" in E.prototype || O(E.prototype, "isConnected", {
            configurable: !0,
            get: function() {
                return !(this.ownerDocument.compareDocumentPosition(this) & this.DOCUMENT_POSITION_DISCONNECTED)
            }
        })
    } else if (P = !self.customElements.get("extends-br")) try {
        var F = function a() {
            return self.Reflect.construct(HTMLBRElement, [], a)
        };
        F.prototype = HTMLLIElement.prototype;
        self.customElements.define("extends-br", F, {
            extends: "br"
        }), P = 0 > v.createElement("br", {
            is: "extends-br"
    ...
    if (P) {
        var Q = function(a) {
            ...
            qa = i({
                query: ma,
                handle: function(a, b) {
                    ga.has(a) && (b ? ha.add(a) : ha.delete(a), na.length && Q.call(na, a))
                }
            }).parse,
            ra = y.prototype.attachShadow;
        ra && (y.prototype.attachShadow = function(a) {
        ...
        D(self).filter(function(a) {
            ...
            var c = self[a];
            O(b.prototype = c.prototype, "constructor", {
                value: b
            }), O(self, a, {
                value: b
            })
        ...
        }, X.get = oa, X.whenDefined = sa, X.upgrade = function(a) {
            ...
            if (oa(a)) throw new M("'".concat(a, "' has already been defined as a custom element"));
            var d, e = c && c.extends;
            ia.set(b, e ? {
                is: a,
                tag: e
                ...
                is: "",
                tag: a
            }), e ? (d = "".concat(e, "[is=\"").concat(a, "\"]"), ka.set(d, b.prototype), la.set(a, b), na.push(d)) : (Z.apply(X, arguments), ma.push(d = a)), sa(a).then(function() {
                e ? (pa(v.querySelectorAll(d)), ha.forEach(Q, [d])) : qa(v.querySelectorAll(d))
            }), ja.get(a)._(b)
        }
    }
}();
class LazyImage extends HTMLImageElement {
    ...
    handleLazy() {
        this.complete || this.classList.contains("loaded") || (this.media.classList.add("loading"), this.addEventListener("load", () => {
            const a = () => {
                this.classList.add("loaded"), this.media.classList.remove("loading")
            };
